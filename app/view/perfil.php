  ...
  <main class="container py-5">
    ...
    <div class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center">
      <div class="list-group">
        <a href="curso_python.php" class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3" aria-current="true">
          <img src="../../public/img/check_40.png" alt="Iconó de curso visto" class="img-fluid" style="width: 40px; height: 40px; object-fit: contain;" />
          <div class="d-flex gap-2 w-100 justify-content-between">
            <div>
              <h6 class="mb-0">Curso de Python</h6>
              <p class="mb-0 opacity-75">Domina fundamentos, estructuras de datos y librerías populares.</p>
            </div>
        ...
        <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
          ...
          <div class="d-flex gap-2 w-100 justify-content-between">
            <div>
              ...
              <p class="mb-0 opacity-75">Solido conocimiento en JavaScript para desarrollo web.</p>
            </div>
        ...
        <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
          ...
          <div class="d-flex gap-2 w-100 justify-content-between">
            <div>
              ...
              <p class="mb-0 opacity-75">Desarrolla habilidades de liderazgo efectivas para equipos de tecnología.</p>
            </div>
